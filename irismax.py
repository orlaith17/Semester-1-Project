...
# Find the max value in a given column
...
with open('iris.csv', newline='') as f:
    ...
    answer = max(float(column[2].replace(',', '')) for column in reader)
    
    print("The maximum petal length of any given iris is", answer,"cm")  
